...
/ip address
add address=172.16.2.2/30 interface=ether1
add address=172.16.4.2/30 interface=ether2
add address=10.10.30.1/24 interface=ether3

/ip pool
add name=dhcp_pool_brl ranges=10.10.30.100-10.10.30.200

/ip dhcp-server
add name=dhcp_brl interface=ether3 address-pool=dhcp_pool_brl
