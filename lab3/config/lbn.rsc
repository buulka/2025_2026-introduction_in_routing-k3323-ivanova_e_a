...
add address=10.0.0.18/30 interface=ether1 comment="to MSK"
add address=10.0.0.21/30 interface=ether2 comment="to NY"
add address=10.0.0.26/30 interface=ether3 comment="to HKI"
